...
(function(){
  ...
  colIndex_sapling <- which(names(sapling_data) == 'mean_wood_density') # which index is the denity colum at
  ...
  # 3x analysis of the seedling density
