# Oranise the data in to 1/4 ha plots for analysis 
(function(){
  ...
  setPlotData <- function(){
    ...
    # place the cuts in the dataframe 
  ...
  setReubenData = function(){
    ...
    res_data <- data.frame(elevation_mean = 0, density_mean = 0, n = 0)[0, ] # create results dataframe 
