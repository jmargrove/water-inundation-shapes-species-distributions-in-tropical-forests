...
handleWd('/global-wood-density-database/')

wd_database <- read.csv('./wood-density-database.csv')
table <-  read.csv('./../inla-species-distributions/tables/species-list-plot.table.csv')
